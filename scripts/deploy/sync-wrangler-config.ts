...
function getApiWorkerVars(
  ...
  return {
    ...
    ...getOptionalProcessEnvVars([
      ...
      'PROJECT_DATA_ARCHIVE_MAX_CANDIDATES_PER_SWEEP',
      'PROJECT_DATA_ARCHIVE_MAX_CANDIDATES_HARD_LIMIT',
      'PROJECT_DATA_ARCHIVE_MAX_CHUNKS_PER_SWEEP',
      'PROJECT_DATA_ARCHIVE_MAX_CHUNKS_HARD_LIMIT',
      'PROJECT_DATA_ARCHIVE_CHUNK_MAX_ROWS',
      'PROJECT_DATA_ARCHIVE_CHUNK_MAX_ROWS_HARD_LIMIT',
      'PROJECT_DATA_ARCHIVE_CHUNK_MAX_BYTES',
      'PROJECT_DATA_ARCHIVE_LEASE_MS',
      'PROJECT_DATA_ARCHIVE_TERMINAL_GRACE_MS',
      'PROJECT_DATA_ARCHIVE_RETRY_BASE_MS',
      'PROJECT_DATA_ARCHIVE_RETRY_MAX_MS',
      'PROJECT_DATA_ARCHIVE_CIRCUIT_FAILURES',
      'PROJECT_DATA_ARCHIVE_CIRCUIT_OPEN_MS',
      'PROJECT_DATA_ARCHIVE_SHARD_COUNT',
      'PROJECT_DATA_ARCHIVE_SHARD_COUNT_HARD_LIMIT',
      'PROJECT_DATA_ARCHIVE_SEARCH_MAX_OWNERS',
      'PROJECT_DATA_ARCHIVE_SEARCH_MAX_OWNERS_HARD_LIMIT',
      'PROJECT_DATA_ARCHIVE_SWEEP_MAX_WALL_MS',
      'PROJECT_DATA_ARCHIVE_SWEEP_MAX_IO_OPS',
      'PROJECT_DATA_ARCHIVE_COPY_EXPANSION_RATIO',
      'PROJECT_DATA_ARCHIVE_ERROR_MAX_CHARS',
      'PROJECT_DATA_ARCHIVE_R2_PREFIX',
      'PROJECT_DATA_ARCHIVE_ROOT_COPY_MAX_RATIO',
