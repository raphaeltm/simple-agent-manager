...
- [x] Execute the ownership transfer atomically via D1 batch: set target role owner, set old owner role, update `projects.user_id`, and insert `project_ownership_transfers`.
