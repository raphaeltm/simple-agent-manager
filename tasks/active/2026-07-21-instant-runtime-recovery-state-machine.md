...
- **Hot-path index (MEDIUM)**: additive migration `0099_tasks_workspace_id_index.sql` adds a partial `idx_tasks_workspace_id` for the recovery-exhaustion task lookup.
