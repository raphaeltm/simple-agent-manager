...
_Archived 2026-09-23 by the weekly queue reconciliation. This work shipped: it landed on `main` via PR #2082 (`www: refresh marketing site with multiplayer, comments, compute pools, events fe`). Its checklist was already complete. Full evidence and method: `tasks/archive/2026-09-23-weekly-queue-reconciliation.md`._
