...
- Prior repair post-mortem (`tasks/archive/2026-08-28-repair-compute-pool-default-editing.md`) says the previous bug came from treating generated pool data as system-owned and not testing the edit workflow visually. This task must test the actual edit/add/remove flow, not only read-only rendering.
