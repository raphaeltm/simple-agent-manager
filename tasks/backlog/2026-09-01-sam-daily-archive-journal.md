...
- [ ] Verify claims against the archive-sharding implementation and task record.
- [ ] Write a layperson-friendly technical journal post under
      `apps/www/src/content/blog/`.
- [ ] Clearly distinguish preparation work from an enabled feature.
