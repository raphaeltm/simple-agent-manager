...
- `PROJECT_DATA_SEARCH_FTS_SCAN_LIMIT` — Full-text index entries a session-scoped search may walk, newest first, to collect that session's newest matches (default: `20000`)
