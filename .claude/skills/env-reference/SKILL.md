...
- `SESSION_SLEEP_AFTER_MS` — Runtime-neutral idle time from the latest complete snapshot before automatic sleep (default: `3600000`)
...
- `SESSION_SLEEP_MAX_ATTEMPTS` — Maximum automatic sleep attempts; exhaustion preserves compute and records the error (default: `3`)
