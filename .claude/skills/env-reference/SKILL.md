...
- `PROJECT_DATA_ARCHIVE_SHARDING_ENABLED` — Production-disabled switch for terminal-session archive sharding and exact archive read routing (default: disabled)
