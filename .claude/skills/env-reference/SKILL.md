...
- `NODE_UNHEALTHY_FLEET_MAX_FRACTION` — Hold destructive unhealthy-node cleanup when this fraction of at least three managed workspace VMs is silent together (default: `0.5`)
