...
- `PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_MAX_STATE_BYTES` — D1 JSON byte ceiling independently enforced for accumulated session and target-batch proof state (default: `1750000`)
