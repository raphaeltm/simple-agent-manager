...
### Other Agents
- OpenAI Codex, Google Gemini, and Mistral Vibe currently only support API keys
- Mistral Vibe uses `MISTRAL_API_KEY` for authentication
- OAuth support planned for future releases for Codex and Gemini
