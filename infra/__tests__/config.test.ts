...
describe('infra config parsing', () => {
  ...
  it('uses stable defaults for configurable deployment policy', () => {
    ...
    expect(parsed).toMatchObject({
      ...
      tempUploadTtlDays: configModule.DEFAULT_TEMP_UPLOAD_TTL_DAYS,
      ttsTtlDays: configModule.DEFAULT_TTS_TTL_DAYS,
  ...
  it.each([
    ...
    ['tempUploadTtlDays', '0', 'must be a positive integer'],
    ['tempUploadTtlDays', '1.5', 'must be a positive integer'],
    ['ttsTtlDays', '0', 'must be a positive integer'],
    ['ttsTtlDays', '1.5', 'must be a positive integer'],
