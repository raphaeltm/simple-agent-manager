...
export const integrations: Integration[] = [
  ...
  },
  {
    ...
    useCases: [
      {
        title: 'European agent infrastructure',
        description: 'Run coding agents and persistent deployments in UpCloud regions.',
      },
    ],
    faq: [
      {
        question: 'Do volumes survive node deletion?',
        answer: 'SAM preserves tracked deployment volumes until explicit teardown.',
      },
    ],
