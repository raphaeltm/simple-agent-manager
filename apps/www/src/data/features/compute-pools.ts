...
export const computePoolsSection: FeatureSection = {
  slug: 'compute-pools',
  label: 'Compute Pools & Cost Reporting',
  title: 'Pick your clouds.\nSee what they cost.',
  subtitle:
  ...
  summary:
    'Real multi-cloud machines with a placement strategy, plus per-user token and compute usage reporting.',
  highlights: [
  ...
  docsHref: '/docs/guides/compute-pools/',
  group: 'run',
  screenshots: [
    {
  ...
  details: [
    ...
    {
      headline: 'See why a node was chosen',
      body: 'Resource requirements resolve from task, trigger, skill, and agent profile down to project and platform defaults. The chat’s infrastructure panel shows the resolved requirement alongside the placement decision — which node won, and why.',
      screenshot: {
    ...
    {
      headline: 'One fleet, every provider',
      body: 'The Nodes page lists every machine across every connected provider side by side, with health, CPU/memory/disk usage, and price. Follow-up work reuses a warm node instead of waiting on a fresh boot.',
      screenshot: {
