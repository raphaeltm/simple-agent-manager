...
preservation (above) instead of stopping the workspace outright, except a check-in that expires
with the agent still mid-turn, which releases the runtime at once.
