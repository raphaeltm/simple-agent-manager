...
SAM picks for you: **connect a cloud provider credential and new work runs on your VMs; connect nothing and it runs Instant.** An [agent profile](#agent-profiles) can pin a runtime explicitly if you want to override that.
