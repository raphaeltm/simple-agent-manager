...
<CardGrid>
  <Card title="Bring Your Own Cloud" icon="cloud">
    Connect a Hetzner, Scaleway, Vultr, or GCP credential and VMs run on your own infrastructure, billed
...
- **Bring your own cloud** — run on your own Hetzner, Scaleway, Vultr, or GCP account, or use hosted compute
