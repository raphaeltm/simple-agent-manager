...
**Simple Agent Manager (SAM)** is an open-source platform for running ephemeral AI coding agent environments. It provisions cloud VMs, sets up devcontainers, and gives you a browser-based interface with your choice of AI coding agent — Claude Code, OpenAI Codex, Google Gemini, Mistral Vibe, or OpenCode.
...
<CardGrid>
  <Card title="Bring Your Own Cloud" icon="cloud">
    You provide your Hetzner, Scaleway, or GCP API token. VMs run on your infrastructure, billed to your account. The platform never stores your cloud credentials as environment variables.
  </Card>
...
- **Five AI agents** — Claude Code, OpenAI Codex, Google Gemini, Mistral Vibe, OpenCode
