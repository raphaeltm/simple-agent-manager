...
<CardGrid>
  <Card title="Bring Your Own Cloud" icon="cloud">
    Connect a Hetzner, Scaleway, Vultr, Infomaniak, DigitalOcean, or GCP credential and VMs run on
    your own infrastructure, billed to your account. On the hosted platform, compute can be provided
    for you. Your cloud credentials are never stored as environment variables.
  </Card>
...
- **Bring your own cloud** — run on your own Hetzner, Scaleway, Vultr, Infomaniak, DigitalOcean, or GCP account, or use hosted compute
