...
<CardGrid>
  <Card title="Bring Your Own Cloud" icon="cloud">
    Connect a Hetzner or Scaleway credential and VMs run on your own infrastructure, billed to your
    account. On the hosted platform, compute can be provided for you. Your cloud credentials are
...
- **Bring your own cloud** — run on your own Hetzner or Scaleway account, or use hosted compute
