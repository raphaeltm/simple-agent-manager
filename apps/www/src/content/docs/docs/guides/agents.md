...
| `get_resource_history`              | Read retained CPU, memory, I/O, and OOM history for a VM-backed workspace. With no arguments it returns the caller's own session — see [Session Resource History](/docs/guides/session-resources/)             |
