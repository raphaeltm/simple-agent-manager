...
| `search_messages` | Search messages by keyword — uses FTS5 full-text search with phrase matching for completed sessions; falls back to keyword matching for active sessions |
