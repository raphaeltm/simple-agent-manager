...
`small` workloads on the default 2 vCPU / 4 GiB / 40 GiB class shape, and two `medium` or `large`
workloads on the matching 4 / 8 / 80 or 8 / 16 / 160 class shapes. Pools still admit strictly by
