...
| `get_event` / `list_subscription_events` / `ack_event_delivery` | Retrieve visible durable project event-bus deliveries and acknowledge only ack-required queued/delivered deliveries |
