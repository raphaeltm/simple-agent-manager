...
| `DEPLOY_SIGNING_PRIVATE_KEY` | Ed25519 deploy payload signing private key (auto-generated if omitted)       |
| `DEPLOY_SIGNING_PUBLIC_KEY`  | Ed25519 deploy payload signing public key (auto-generated if omitted)        |
