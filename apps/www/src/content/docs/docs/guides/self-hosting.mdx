...
| `GOOGLE_CLIENT_ID`                         | Optional Google OAuth client ID; can be configured in `/setup` instead             |
| `GOOGLE_CLIENT_SECRET`                     | Optional Google OAuth client secret; can be configured in `/setup` instead         |
