...
Note that connecting a cloud credential also changes **where new sessions run** — see [Instant Sessions](/docs/guides/instant-sessions/#when-sam-uses-an-instant-session).
