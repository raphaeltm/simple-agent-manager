...
| `WORKSPACE_DELETION_ALARM_BATCH_SIZE`              | `4`                | Maximum due workspace-deletion entries processed by one NodeLifecycle alarm, sized to stay within the Cloudflare Free-plan D1 query budget on the worst retry path.                                                                                        |
