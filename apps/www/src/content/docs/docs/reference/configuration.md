...
| `MAX_WORKSPACES_PER_NODE`                         | `3`                | Deprecated compatibility setting; retained for existing configuration but no longer gates placement                   |
...
| `MAX_MESSAGES_PAYLOAD_BYTES`                                 | `262144`           | Maximum serialized VM message request body bytes                                                                                                                                                                          |
| `MAX_MESSAGE_UPLOAD_BYTES`                                   | `8388608`          | Maximum reassembled content plus tool metadata bytes for one VM message upload                                                                                                                                            |
| `MAX_MESSAGE_UPLOAD_PARTS`                                   | `256`              | Maximum parts for each field of one VM message upload                                                                                                                                                                      |
| `MAX_MESSAGE_UPLOAD_SESSION_BYTES`                           | `16777216`         | Maximum staged VM message upload bytes per session, including interrupted uploads                                                                                                                                         |
| `MAX_MESSAGE_UPLOAD_STAGED_BYTES`                            | `67108864`         | Maximum staged VM message upload bytes per project object, including interrupted uploads                                                                                                                                  |
| `MAX_MESSAGE_UPLOAD_STAGED_PARTS`                            | `4096`             | Maximum staged VM message upload parts per project object                                                                                                                                                                 |
| `MAX_MESSAGE_UPLOAD_INVENTORY_LIMIT`                          | `100`              | Maximum records in one superadmin VM message-upload quarantine inventory page                                                                                                                                            |
