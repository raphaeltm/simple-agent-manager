...
| Variable                                   | Default          | Description                                                                                                                                                                                |
| ------------------------------------------ | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `CF_CONTAINER_ENABLED`                     | `true`           | Enables Cloudflare Container instant sessions for matching profiles and no-credential last-resort runtime selection. Project, user, or platform cloud credentials still prefer VM runtime. |
...
| `PROJECT_DATA_ARCHIVE_SHARDING_ENABLED`                    | `false`                      | Production-disabled switch for terminal-session archive sharding; exact routing code remains available but the coordinator does no work unless explicitly enabled                      |
