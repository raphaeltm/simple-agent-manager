...
| `NODE_UNHEALTHY_FLEET_MAX_FRACTION`                | `0.5`              | Holds destructive cleanup when this fraction of at least three managed workspace VMs lose heartbeat together, indicating a possible heartbeat-intake incident.                                                                                          |
