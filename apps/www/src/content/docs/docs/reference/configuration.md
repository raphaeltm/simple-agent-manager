...
| `PROJECT_EVENT_SCHEDULE_PROMPT_MAX_BYTES`                   | `32768`            | Maximum scheduled action prompt size in UTF-8 bytes; task submission also enforces MAX_TASK_MESSAGE_LENGTH                                                                                                                 |
