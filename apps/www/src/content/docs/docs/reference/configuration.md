...
| `PROJECT_DATA_ARCHIVE_DAILY_WRITE_BUDGET`           | `250000`    | Installation-wide daily estimated SQL write allowance for compact migration attempts; 0 pauses admission. The checked-in `wrangler.toml` ships `800000` (measured amplification 4.6-6.7x keeps account under 50M/month included writes). |
