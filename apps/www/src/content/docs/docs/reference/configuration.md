...
| `CREDENTIAL_LIMIT_ADMISSION_RETRY_BATCH_SIZE`            | `25`              | Maximum pending or failed credential-limit admission envelopes retried per opportunistic sweep                                                                                   |
...
| `CREDENTIAL_LIMIT_ADMISSION_RETENTION_DAYS`              | `30`              | Retention window for credential-limit admission/outbox rows                                                                                                                      |
