...
| `PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_MAX_TOTAL_R2_OPERATIONS`   | _(empty)_                       | Hard cumulative R2 operation ceiling including manifest verification; required with a fixed cleanup cutoff                                                                                          |
| `PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_MAX_TOTAL_WALL_TIME_MS`    | _(empty)_                       | Hard cumulative cleanup wall-time ceiling; required with a fixed cleanup cutoff                                                                                                                     |
