...
| `MCP_EVENT_BUS_CURSOR_MAX_LENGTH`            | `512`             | Maximum opaque cursor characters accepted for one `list_subscription_events` request.                           |
...
| `PROJECT_DATA_EVENT_BUS_PAYLOAD_MAX_BYTES`                 | `262144`                     | Maximum stored ProjectData event-bus payload bytes per event                                                                                                                           |
| `PROJECT_DATA_EVENT_BUS_METADATA_MAX_BYTES`                | `16384`                      | Maximum stored ProjectData event-bus metadata bytes per event                                                                                                                          |
| `PROJECT_DATA_EVENT_BUS_MAX_ROUTED_SUBSCRIPTIONS`          | `1000`                       | Maximum active subscriptions routed by one ProjectData event publish                                                                                                                   |
| `PROJECT_DATA_EVENT_BUS_RETENTION_DAYS`                    | `14`                         | Age before old event-bus events without pending ack-required deliveries may be pruned from ProjectData                                                                                 |
| `PROJECT_DATA_EVENT_BUS_RETENTION_BATCH_ROWS`              | `500`                        | Maximum old event-bus events pruned per ProjectData alarm                                                                                                                              |
...
| `MCP_EVENT_BUS_CURSOR_MAX_LENGTH`      | `512`   | Max cursor characters per `list_subscription_events` request |
