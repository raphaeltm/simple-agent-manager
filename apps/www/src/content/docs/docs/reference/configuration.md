...
| `PROJECT_DATA_ARCHIVE_SEARCH_MAX_OWNERS`                         | `4`                             | Archive-shard owner batch size for one project-wide message-search continuation; callers continue until coverage is complete                                                                                                                             |
| `PROJECT_DATA_ARCHIVE_SEARCH_CONCURRENCY`                        | `4`                             | Maximum concurrent archive-owner queries within one project-wide message-search batch                                                                                                                                                                    |
