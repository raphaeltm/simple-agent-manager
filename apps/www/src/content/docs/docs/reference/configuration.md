...
| `TASK_RECONCILIATION_CANDIDATE_LEASE_MS`           | `30000` (30 sec)                       | Durable claim window preventing overlapping alarms from repeating task reconciliation probes or delivery                                                                                                                                                               |
