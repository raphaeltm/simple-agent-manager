...
| `PROJECT_DATA_SEARCH_FTS_SCAN_LIMIT`                             | `20000`                         | Full-text index entries a session-scoped search may walk, newest first, to collect that session's newest matches                                                                                                                                         |
