...
| `DO_SHARD_MIGRATION_THRESHOLD_BYTES`    | `7516192768` (7 GiB)   | Primary ProjectData DO storage estimate that starts stopped-session shard migration                                                                                              |
| `DO_SHARD_AGGRESSIVE_THRESHOLD_BYTES`   | `9126805504` (8.5 GiB) | Storage estimate that drains toward `DO_SHARD_TARGET_SIZE_BYTES` instead of only below the migration threshold                                                                   |
| `DO_SHARD_HARD_BRAKE_THRESHOLD_BYTES`   | `9663676416` (9 GiB)   | Storage estimate that processes full bounded migration batches while eligible stopped sessions remain                                                                            |
| `DO_SHARD_TARGET_SIZE_BYTES`            | `5368709120` (5 GiB)   | Target primary ProjectData DO storage estimate during aggressive migration                                                                                                       |
| `DO_SHARD_MAX_SIZE_BYTES`               | `2147483648` (2 GiB)   | Estimated migrated payload ceiling for each same-class ProjectData shard DO                                                                                                      |
| `DO_SHARD_MIGRATION_BATCH_SIZE`         | `10`                   | Max stopped sessions migrated by one ProjectData alarm turn; runtime caps unsafe large overrides                                                                                 |
| `DO_SHARD_CHECK_INTERVAL_MS`            | `3600000` (1 h)        | Recheck interval while ProjectData sharding work remains                                                                                                                         |
