...
| `PROJECT_DATA_ARCHIVE_SEARCH_ERROR_LIMIT`                        | `20`                            | Maximum public owner/index error examples retained in continuation metadata (maximum 100); full details remain in server logs                                                                                                                              |
