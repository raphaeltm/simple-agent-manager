...
CREATE UNIQUE INDEX IF NOT EXISTS idx_credentials_user_agent_kind_user_scope
  ON credentials (user_id, agent_type, credential_kind)
  WHERE credential_type = 'agent-api-key' AND project_id IS NULL;

CREATE UNIQUE INDEX IF NOT EXISTS idx_credentials_user_agent_kind_project_scope
