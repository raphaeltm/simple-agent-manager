...
export type Env = {
  ...
  PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_PLAN_ID?: string;
  PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_MANIFEST_KEY?: string;
  PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_MANIFEST_SHA256?: string;
  PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_BATCH_MANIFEST_MAX_BYTES?: string;
  PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_ROOT_MANIFEST_MAX_BYTES?: string;
  PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_MAX_TOTAL_ROWS?: string;
  PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_MAX_TOTAL_BYTES?: string;
  PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_MAX_TOTAL_R2_OPERATIONS?: string;
  PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_MAX_TOTAL_WALL_TIME_MS?: string;
  PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_PROJECT_IDS?: string;
  PROJECT_DATA_TOOL_PAYLOAD_CLEANUP_CUTOFF_CREATED_AT?: string;
  ...
  PROJECT_DATA_TOOL_PAYLOAD_MANUAL_CLEANUP_MAX_BATCH_ROWS?: string;
  PROJECT_DATA_TOOL_PAYLOAD_MANUAL_CLEANUP_MAX_BATCH_BYTES?: string;
  PROJECT_DATA_TOOL_PAYLOAD_MANUAL_CLEANUP_MAX_WALL_TIME_MS?: string;
  PROJECT_DATA_TOOL_PAYLOAD_MANUAL_CLEANUP_RECHECK_MS?: string;
  ...
  PROJECT_DATA_TOOL_PAYLOAD_ARCHIVE_MAX_OPERATIONS?: string;
  PROJECT_DATA_TOOL_PAYLOAD_ARCHIVE_RETRY_DELAY_MS?: string;
  PROJECT_DATA_TOOL_PAYLOAD_ARCHIVE_CHUNK_BYTES?: string;
  PROJECT_DATA_TOOL_PAYLOAD_ARCHIVE_MAX_METADATA_BYTES?: string;
  PROJECT_DATA_STORAGE_RELIEF_MEASURE_BATCH_ROWS?: string;
  PROJECT_DATA_STORAGE_RELIEF_MEASURE_MAX_BATCH_ROWS?: string;
  PROJECT_DATA_GROUPED_FTS_CLEANUP_ENABLED?: string;
  ...
  PROJECT_DATA_ARCHIVE_R2_TIMEOUT_MS?: string;
  PROJECT_DATA_ARCHIVE_BUDGET_RECEIPT_RETENTION_MS?: string;
  PROJECT_DATA_ARCHIVE_BUDGET_RECEIPT_CLEANUP_LIMIT?: string;
  PROJECT_DATA_ARCHIVE_GLOBAL_SWEEP_ENABLED?: string;
  PROJECT_DATA_ARCHIVE_GLOBAL_SWEEP_INTERVAL_MS?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_ENABLED?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_PLAN_ID?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_PROJECT_ID?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_CUTOFF_CREATED_AT?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_BATCH_ROWS?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_INTERVAL_MS?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_MAX_BATCHES?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_MAX_ROWS?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_MAX_BYTES?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_LEASE_MS?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_WALL_TIME_MS?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_SLICES_PER_RUN?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_RUN_WALL_TIME_MS?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_LEASE_MARGIN_MS?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_RETURN_MARGIN_MS?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_MEASUREMENT_WALL_TIME_MS?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_MAX_STATE_BYTES?: string;
  PROJECT_DATA_STORAGE_RELIEF_PREFLIGHT_ERROR_MAX_LENGTH?: string;
  ...
  PROJECT_DATA_ARCHIVE_PRECOPY_REFUSAL_RETRY_MS?: string;
  PROJECT_DATA_ARCHIVE_FAILED_RETRY_DELAY_MS?: string;
  ...
  TASK_RECONCILIATION_MAX_CANDIDATES_PER_SWEEP?: string;
  TASK_RECONCILIATION_NODE_CALL_TIMEOUT_MS?: string;
  TASK_RECONCILIATION_CANDIDATE_LEASE_MS?: string;
  TASK_RECONCILIATION_PROBE_MAX_ATTEMPTS?: string;
  TASK_RECONCILIATION_QUARANTINE_MS?: string;
  ...
  SESSION_SLEEP_IN_FLIGHT_MAX_AGE_MS?: string;
  SESSION_SLEEP_IN_FLIGHT_REPAIR_BATCH_SIZE?: string;
  TERMINAL_NODE_LIFECYCLE_REPAIR_BATCH_SIZE?: string;
  TERMINAL_NODE_LIFECYCLE_REPAIR_WALL_BUDGET_MS?: string;
