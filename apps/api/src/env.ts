...
export interface Env extends WebhookTriggerEnv, TaskRecoveryEnv {
  ...
  DEPLOYMENT_IMAGE_RESOLVE_DNS_LOOKUP_TIMEOUT_MS?: string; // Per-host DNS preflight timeout (default: 10000)
  DEPLOYMENT_IMAGE_RESOLVE_MAX_DNS_LOOKUPS?: string; // Max DNS preflight lookups per resolver instance (default: 400)
  DEPLOYMENT_IMAGE_RESOLVE_DNS_RESPONSE_MAX_BYTES?: string; // Max DNS-over-HTTPS JSON response size (default: 32768)
  DEPLOYMENT_IMAGE_RESOLVE_DOH_RESOLVER_URL?: string; // DNS-over-HTTPS resolver for image-registry preflight (default: https://cloudflare-dns.com/dns-query)
