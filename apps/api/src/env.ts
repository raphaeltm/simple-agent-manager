...
export interface Env {
  ...
  AGENT_SETTINGS_MAX_MODEL_LENGTH?: string;
  AGENT_SETTINGS_MAX_TOOL_NAME_LENGTH?: string;
  AGENT_SETTINGS_MAX_TOOL_LIST_LENGTH?: string;
  AGENT_SETTINGS_MAX_ENV_VARS?: string;
  AGENT_SETTINGS_MAX_ENV_KEY_LENGTH?: string;
  AGENT_SETTINGS_MAX_ENV_VALUE_LENGTH?: string;
  AGENT_SETTINGS_MAX_PROVIDER_NAME_LENGTH?: string;
  AGENT_SETTINGS_MAX_BASE_URL_LENGTH?: string;
