...
export interface Env extends WebhookTriggerEnv, TaskRecoveryEnv {
  ...
  MAX_MESSAGE_UPLOAD_BYTES?: string;
  MAX_MESSAGE_UPLOAD_PARTS?: string;
  MAX_MESSAGE_UPLOAD_SESSION_BYTES?: string;
  MAX_MESSAGE_UPLOAD_STAGED_BYTES?: string;
  MAX_MESSAGE_UPLOAD_STAGED_PARTS?: string;
  MAX_MESSAGE_UPLOAD_INVENTORY_LIMIT?: string;
