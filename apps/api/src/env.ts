...
export interface Env extends WebhookTriggerEnv, TaskRecoveryEnv {
  ...
  LIBRARY_MCP_QUESTION_MAX_LENGTH?: string; // Max question length for display_from_library cards (default: 500)
  LIBRARY_MCP_DISPLAY_MAX_LINE_GROUPS?: string; // Max focused line groups for display_from_library cards (default: 20)
  LIBRARY_MCP_DISPLAY_LINE_GROUP_LABEL_MAX_LENGTH?: string; // Max line group label length for display_from_library cards (default: 120)
