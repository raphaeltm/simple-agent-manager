...
export interface Env {
  ...
  // MCP token TTL in seconds (default 28800 = 8 hours); sliding window refreshes on each use
  MCP_TOKEN_TTL_SECONDS?: string;
  // MCP token absolute max lifetime in seconds (default 86400 = 24 hours); caps sliding window
