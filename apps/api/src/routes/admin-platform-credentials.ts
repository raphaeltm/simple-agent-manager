 ...
 */
adminPlatformCredentialRoutes.post(
  '/',
  jsonValidator(CreatePlatformCredentialSchema),
  async (c) => {
    ...
    if (body.credentialType === 'cloud-provider' && body.provider && body.provider !== 'gcp') {
      try {
        const providerConfig = buildProviderConfig(
          body.provider as CredentialProvider,
          body.credential
        );
 ...
 */
adminPlatformCredentialRoutes.patch(
  '/:id',
  jsonValidator(UpdatePlatformCredentialSchema),
  async (c) => {
