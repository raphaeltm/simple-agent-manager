...
export function toProjectResponse(project: schema.Project): Project {
  return {
    ...
    defaultResourceRequirements: project.defaultResourceRequirementsJson
      ? JSON.parse(project.defaultResourceRequirementsJson) as Project['defaultResourceRequirements']
      : null,
...
export function toTaskResponse(task: schema.Task, blocked = false): Task {
  return {
    ...
    requestedProvider: task.requestedProvider ?? null,
    requestedProviderSource: (task.requestedProviderSource as Task['requestedProviderSource']) ?? null,
    requestedVmLocation: task.requestedVmLocation ?? null,
    requestedVmLocationSource: (task.requestedVmLocationSource as Task['requestedVmLocationSource']) ?? null,
    requestedWorkspaceProfile: task.requestedWorkspaceProfile ?? null,
    requestedWorkspaceProfileSource: (task.requestedWorkspaceProfileSource as Task['requestedWorkspaceProfileSource']) ?? null,
    requestedTaskMode: (task.requestedTaskMode as TaskMode | null) ?? null,
    requestedTaskModeSource: (task.requestedTaskModeSource as Task['requestedTaskModeSource']) ?? null,
