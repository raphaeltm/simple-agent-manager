...
describe('Env interface', () => {
  ...
  it('declares all TaskRunner env vars', () => {
    const envVars = [
      ...
      'TASK_RUNNER_AGENT_READY_FRESHNESS_SKEW_MS',
      'TASK_RUNNER_WORKSPACE_DISPATCH_TIMEOUT_MS',
      'TASK_RUNNER_WORKSPACE_DISPATCH_BASE_DELAY_MS',
      'TASK_RUNNER_WORKSPACE_DISPATCH_MAX_DELAY_MS',
      'TASK_RUNNER_WORKSPACE_READY_TIMEOUT_MS',
      'TASK_RUNNER_WORKSPACE_READY_POLL_INTERVAL_MS',
      'TASK_RUNNER_PROVISION_POLL_INTERVAL_MS',
      'TASK_RUNNER_PROVISION_TIMEOUT_MS',
    ];
