...
import { TaskHierarchyPrototype } from './pages/task-hierarchy-prototype';
          ...
          <ToastProvider>
            ...
            <BrowserRouter>
              ...
              <Routes>
                ...
                {/* PROTOTYPE ONLY — task hierarchy design exploration, remove before merge */}
                <Route path="/prototype/task-hierarchy" element={<TaskHierarchyPrototype />} />
