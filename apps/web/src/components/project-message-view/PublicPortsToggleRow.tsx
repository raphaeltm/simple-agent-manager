  ...
  return (
    <div className="border-t border-[rgba(34,197,94,0.08)] px-4 py-2">
      <div className="flex items-center gap-2.5">
        ...
        >
          <span
            className={`block h-3.5 w-3.5 rounded-full bg-fg-primary shadow transition-transform ${enabled ? 'translate-x-[17px]' : 'translate-x-[3px]'}`}
          />
        </button>
        <div className="min-w-0">
          ...
          {error && (
            <p
              className="mt-0.5 flex items-center gap-1 text-[11px] leading-snug text-red-300"
              role="alert"
            >
