...
import { GitChangesButton } from '../GitChangesButton';
...
export const WorkspaceHeader: FC<WorkspaceHeaderProps> = ({
  ...
  >
    ...
    {/* Worktree selector */}
    {isRunning && terminalToken && workspace?.url && workspaceId && (
      <WorktreeSelector
        worktrees={worktrees}
    ...
    {isRunning && terminalToken && (
      <FileBrowserButton onClick={onOpenFileBrowser} isMobile={isMobile} compactMobile={isMobile} />
    )}
    ...
    {isRunning && terminalToken && isMobile && (
      <CommandPaletteButton onClick={onOpenCommandPalette} isMobile compactMobile />
    )}
