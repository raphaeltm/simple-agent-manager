...
export const DEFAULT_SERVER_STABLE_LOAD_ATTEMPTS = 3;
...
export const DEFAULT_THREAD_LOCK_TIMEOUT_MS = 5_000;
export const DEFAULT_THREAD_LOCK_RETRY_MS = 25;
export const DEFAULT_THREAD_LOCK_STALE_MS = 30_000;
