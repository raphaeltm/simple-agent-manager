...
export const AGENT_CATALOG: readonly AgentDefinition[] = [
  ...
  },
  {
    ...
    installCommand:
      'curl -LsSf https://astral.sh/uv/install.sh | UV_INSTALL_DIR=/usr/local/bin sh && UV_TOOL_DIR=/opt/uv-tools UV_PYTHON_INSTALL_DIR=/opt/uv-python UV_TOOL_BIN_DIR=/usr/local/bin uv tool install mistral-vibe==2.4.2 --python 3.12 --quiet',
  },
] as const;
