 ...
 */
export const MCP_CONNECTION_NAME_PATTERN = /^[a-z0-9][a-z0-9-]{0,30}[a-z0-9]$|^[a-z0-9]$/;

export const MCP_CONNECTION_NAME_RULE =
  'name must be 1-32 characters of lowercase letters, digits or hyphens, and may not start or end with a hyphen';
