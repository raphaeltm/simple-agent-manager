...
export const PLATFORM_AI_MODELS: PlatformAIModel[] = [
  ...
  },
  {
    ...
    fallbackGroup: 'anthropic-standard',
    allowedScopes: ['workspace', 'project', 'top-level'],
    unifiedApiModelId: 'anthropic/claude-sonnet-4-5-20250514',
  },
  {
  ...
  },
  {
    ...
    fallbackGroup: 'anthropic-standard',
    allowedScopes: ['workspace', 'project', 'top-level'],
    unifiedApiModelId: 'anthropic/claude-3-5-sonnet-20241022',
  },
  {
    ...
    fallbackGroup: 'anthropic-fast',
    allowedScopes: ['workspace', 'project', 'top-level'],
    unifiedApiModelId: 'anthropic/claude-3-5-haiku-20241022',
  },
  {
    ...
    fallbackGroup: 'anthropic-premium',
    allowedScopes: ['workspace', 'project', 'top-level'],
    unifiedApiModelId: 'anthropic/claude-3-opus-20240229',
  },
