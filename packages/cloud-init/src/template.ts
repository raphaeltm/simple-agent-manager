 ...
 * bootstrap that must exist before the agent can serve traffic, then starts
 * the agent. For deployment nodes, that includes installing and enabling Caddy.
 * The agent still handles Docker, Node.js, firewall, and release apply work.
 *
...
runcmd:
  # =====================================================================
  # Cloud-init keeps bootstrap minimal: download vm-agent, perform role-specific
  # service setup required before traffic can be served, then start vm-agent.
  # This prevents deployment nodes from heartbeating and applying releases
  # before Caddy exists.
  # =====================================================================
