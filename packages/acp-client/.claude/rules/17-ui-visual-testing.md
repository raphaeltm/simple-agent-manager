...
**Responsive containers change layout _semantics_, not just sizes.** A guarantee that
...
Before merging a conditional assertion, ask: _under what fixture does this branch
actually run?_ If you cannot name it, instrument the condition and measure it.
